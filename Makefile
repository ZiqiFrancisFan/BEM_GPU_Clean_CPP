...
OBJ = main.o numerical.o mesh.o GMRES.o atomicFuncs.o warpAcceleration.o
#     Bias.o  
...
numerical.o : numerical.cu numerical.h mesh.h warpAcceleration.h
	$(NVCCONLY) -dc $(INCLUDES) $(ALL_CCFLAGS) $(EXTRA_CCFLAGS) $(GENCODE_FLAGS) numerical.cu
	
mesh.o: mesh.cu mesh.h numerical.h
	$(NVCCONLY) -dc $(INCLUDES) $(ALL_CCFLAGS) $(EXTRA_CCFLAGS) $(GENCODE_FLAGS) mesh.cu
	
GMRES.o: GMRES.cu GMRES.h numerical.h
	$(NVCCONLY) -dc $(INCLUDES) $(ALL_CCFLAGS) $(EXTRA_CCFLAGS) $(GENCODE_FLAGS) GMRES.cu
	
atomicFuncs.o: atomicFuncs.cu atomicFuncs.h numerical.h
	$(NVCCONLY) -dc $(INCLUDES) $(ALL_CCFLAGS) $(EXTRA_CCFLAGS) $(GENCODE_FLAGS) atomicFuncs.cu
	
warpAcceleration.o: warpAcceleration.cu warpAcceleration.h
	$(NVCCONLY) -dc $(INCLUDES) $(ALL_CCFLAGS) $(EXTRA_CCFLAGS) $(GENCODE_FLAGS) warpAcceleration.cu
